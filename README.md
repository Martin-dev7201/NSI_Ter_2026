...
```
.
├── algo/               # Algorithmique (tri, recherche, récursivité, complexité)
├── structures/         # Structures de données (piles, files, listes, arbres, graphes)
├── bdd/                # Bases de données (SQL, modèle relationnel)
├── reseaux/            # Réseaux et protocoles (TCP/IP, routage, HTTP)
├── archi/              # Architecture matérielle (logique booléenne, assembleur)
├── langages/           # Programmation (Python, paradigmes, POO)
├── projet/             # Projet de fin d'année (grand oral / dossier)
└── README.md
```
